...
class ApplyRequest(BaseModel):
    ...
    candidate_email: str
    candidate_phone: str
    # bat buoc chon Nguon ho so tu danh muc da cau hinh (candidate_sources),
    source_business_id: str
    ai_consent: bool
    # Cho phep (khong bat buoc) Candidate tu khai bao them thong tin luc ung tuyen 
...
class ApplicationOut(BaseModel):
    ...
    job_business_id: str
    job_title: str
    # candidate xem "Ho so cua toi" phai thay duoc mo ta/yeu cau cong
